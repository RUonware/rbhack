...
-- === Speed & Jump Boost Ekleme ===
local boostFrame = Instance.new("Frame", main)
...
speedBoostBox.TextSize = 16
Instance.new("UICorner",speedBoostBox).CornerRadius=UDim.new(0,6)
...
jumpBoostBox.TextSize = 16
Instance.new("UICorner",jumpBoostBox).CornerRadius=UDim.new(0,6)
